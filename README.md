...
sys.exit(app.exec_())
```
Ici `Ui_MainWindow()` est la classe que PyQt Designer a crée(celle qui contiend votre interface et le reste de votre code), si vous renommez la première classe de votre script vous devrez aussi changer cette ligne.
